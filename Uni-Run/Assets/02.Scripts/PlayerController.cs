...
{
    public AudioClip deathCip; // 사망 시 재생할 오디오 클립
    public float jumpForce = 700f; // 점프 힘

    private int jumpCount = 0; // 누적 점프 회수
    ...
    { //사용자 입력을 감지하고 점프하는 처리
        ...
        //애니메이터의 Grounded 피라미터를 isGrounded 값으로 갱신
